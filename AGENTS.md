...
- Roadmap Phase 2 (next): CSV export/import (customer accounts ✅, reviews ✅, wishlists ✅, FTS search ✅ done); Phase 3: fulfillment tracking (API ✅), abandoned-cart queue (persistence + conversion wired 2026-08-29; not pg-boss), outbound merchant webhooks ✅, multi-warehouse (API ✅, **checkout-integrated 2026-08-29**), i18n ar+RTL (missing)
