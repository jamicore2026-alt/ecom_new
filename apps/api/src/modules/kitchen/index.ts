...
export const kitchenModule = new Elysia({ prefix: '/api' })
  ...
  .get('/kitchen-stations', async ({ query, auth, merchantContext }) => KitchenStationsService.list(auth.merchant.id, query, merchantContext), {
    query: kitchenStationQuery,
    detail: { summary: 'List kitchen stations' }
  })
  .get('/kitchen-stations/:id', async ({ params, auth, merchantContext }) => KitchenStationsService.get(auth.merchant.id, params.id, merchantContext), {
    params: kitchenParams,
    detail: { summary: 'Get a kitchen station' }
  })
  .get('/kitchen/tickets', async ({ query, auth, merchantContext }) => KitchenTicketsService.list(auth.merchant.id, query, merchantContext), {
    query: kotTicketQuery,
    detail: { summary: 'List kitchen tickets (KOT)' }
  })
  .get('/kitchen/kds', async ({ query, auth, merchantContext }) => KdsBoardService.board(auth.merchant.id, query, merchantContext), {
    query: kitchenStationQuery,
    detail: { summary: 'KDS display board grouped by station' }
  })
  .get('/kitchen/tickets/:id', async ({ params, auth, merchantContext }) => KitchenTicketsService.get(auth.merchant.id, params.id, merchantContext), {
    params: kitchenParams,
  ...
  .post('/kitchen-stations', async ({ body, auth, request, merchantContext }) => {
    const result = await KitchenStationsService.create(auth.merchant.id, body, merchantContext)
  ...
  .put('/kitchen-stations/:id', async ({ params, body, auth, request, merchantContext }) => {
    const result = await KitchenStationsService.update(auth.merchant.id, params.id, body, merchantContext)
  ...
  .delete('/kitchen-stations/:id', async ({ params, auth, request, merchantContext }) => {
    const result = await KitchenStationsService.remove(auth.merchant.id, params.id, merchantContext)
  ...
  .post('/kitchen/orders/:id/tickets', async ({ params, body, auth, request, merchantContext }) => {
    const result = await KitchenTicketsService.generateForOrder(auth.merchant.id, params.id, body.priority, merchantContext)
  ...
  .post('/kitchen/tickets/:id/status', async ({ params, body, auth, request, merchantContext }) => {
    const result = await KitchenTicketsService.transition(auth.merchant.id, params.id, body.status, merchantContext)
  ...
  .post('/kitchen/tickets/:id/bump', async ({ params, auth, request, merchantContext }) => {
    const result = await KitchenTicketsService.bump(auth.merchant.id, params.id, merchantContext)
  ...
  .post('/kitchen/tickets/:id/recall', async ({ params, auth, request, merchantContext }) => {
    const result = await KitchenTicketsService.recall(auth.merchant.id, params.id, merchantContext)
  ...
  .put('/kitchen/tickets/:id/priority', async ({ params, body, auth, request, merchantContext }) => {
    const result = await KitchenTicketsService.setPriority(auth.merchant.id, params.id, body.priority, merchantContext)
  ...
  .post('/kitchen/tickets/:id/items/:itemId/status', async ({ params, body, auth, request, merchantContext }) => {
    const result = await KitchenTicketsService.itemStatus(auth.merchant.id, params.id, params.itemId, body.status, merchantContext)
