...
export const NAV_ITEMS: NavItem[] = [
	...
	{ label: 'Procurement', route: '/procurement', icon: 'local_shipping', group: 'Sell', module: 'inventory', permission: ['inventory.read', 'inventory.manage'] },
	{ label: 'Production', route: '/production', icon: 'factory', group: 'Sell', module: 'inventory', permission: ['inventory.read', 'inventory.manage'] },
