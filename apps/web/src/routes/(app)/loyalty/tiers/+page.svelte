...
<div class="mb-6 flex flex-wrap gap-1 rounded border border-outline-variant bg-surface-container-lowest p-1">
	...
	<a href="/loyalty/tiers" aria-current="page" class="rounded bg-surface-container px-3 py-1.5 text-sm font-medium max-sm:min-h-11 max-sm:inline-flex max-sm:items-center text-on-surface">Tiers</a>
